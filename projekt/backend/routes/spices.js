...
router.put('/:id', async (req, res) => {
    ...
    try {
        await Spice.findOneAndReplace({_id: req.params.id}, req.body, err =>
...
router.delete('/:id', async (req, res) => {
    try {
        await Spice.findOneAndRemove({_id: req.params.id}, err =>
...
router.patch('/:id', async (req, res) => {
    ...
    try {
        await Spice.findOneAndUpdate({_id: req.params.id}, req.body, err =>
